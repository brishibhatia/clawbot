...
// Manual .env parsing to avoid dependency on dotenv package
function loadEnv() {
    try {
...
async function main() {
    ...
    // Read bytecode.json
    // The format from `sui move build --dump-bytecode-as-base64` might include warnings.
    // The last line containing JSON object with "modules" key is what we want.
